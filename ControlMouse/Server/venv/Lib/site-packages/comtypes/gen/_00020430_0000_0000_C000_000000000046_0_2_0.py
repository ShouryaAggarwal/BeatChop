...
IFontDisp = Font
__all__ = [ 'OLE_YSIZE_PIXELS', 'OLE_OPTEXCLUSIVE',
           'OLE_YSIZE_HIMETRIC', 'IPicture', 'OLE_XSIZE_HIMETRIC',
           'FONTUNDERSCORE', 'LoadPictureConstants',
           'OLE_XPOS_PIXELS', 'IPictureDisp', 'OLE_YSIZE_CONTAINER',
           'FONTBOLD', 'OLE_YPOS_PIXELS', 'FontEvents', 'StdFont',
           'OLE_YPOS_CONTAINER', 'Checked', 'FONTNAME', 'Gray',
           'VgaColor', 'OLE_XPOS_HIMETRIC', 'IFontDisp', 'Color',
           'FONTITALIC', 'OLE_HANDLE', 'OLE_CANCELBOOL',
           'OLE_XSIZE_CONTAINER', 'FONTSTRIKETHROUGH',
           'OLE_XPOS_CONTAINER', 'Font', 'FONTSIZE', 'Picture',
           'IFontEventsDisp', 'OLE_TRISTATE', 'OLE_XSIZE_PIXELS',
           'OLE_COLOR', 'Unchecked', 'IFont', 'StdPicture',
           'OLE_ENABLEDEFAULTBOOL', 'Default', 'Monochrome',
           'OLE_YPOS_HIMETRIC']
